...
export default function SignUp5 () {
  ...
  const [choice, setChoice] = useState('I want to trade with my friends');
  const options = [
    { label: 'I want to trade with my friends'},
    { label: 'I want to understand the stock market'},
    { label: 'I want to hedge'},
    { label: 'I want to learn investments'},
    { label: 'I still do not know for sure'}];
  ...
  return ( 
    <Background>
        ...
        <View style={styles.toptextbox}>
            ...
            <View style={styles.questionbox}>
              <View style={[{display: 'flex'}, {flexDirection: 'column'}, {alignItems: 'flex-start'}]}>
                <Text style={globalFonts.H3(globalColors.others.white.color)}>What do you hope to achieve with Hedgenet trading? 🚀</Text>
              </View>    
            </View>
            {options.map((option) => (
                ...
                <RadioButton
                    ...
                    status={choice === option.label ? 'checked' : 'unchecked'}
      ...
      <View style={styles.bottomgreybutton}>
          <TouchableOpacity style={styles.continuebutton} onPress={() => {if (choice !== '') { console.log(`Choice: ${choice}`)}; {navigation.navigate('SignUp6');}}}>

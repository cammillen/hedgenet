...
export default function SignUp2 () {
  ...
  const [ismale, setIsMale] = useState('I am male');
  const sex = [
    { label: 'I am male'},
    { label: 'I am female'}];
  ...
  return ( 
    <Background>
        ...
        <View style={styles.toptextbox}>
            ...
            <View style={styles.questionbox}>
              <View style={[{display: 'flex'}, {flexDirection: 'column'}, {alignItems: 'flex-start'}]}>
                <Text style={globalFonts.H3(globalColors.others.white.color)}>What is your gender?🚻</Text>
              </View>    
            </View>
            {sex.map((option) => (
                ...
                <RadioButton
                    ...
                    status={ismale === option.label ? 'checked' : 'unchecked'}
                    onPress={() => {setIsMale(option.label)}}
      ...
      <View style={styles.bottomgreybutton}>
          <TouchableOpacity style={styles.continuebutton} onPress={() => {if (ismale !== '') { console.log(`Sex: ${ismale}`)}; {navigation.navigate('SignUp3');}}}>

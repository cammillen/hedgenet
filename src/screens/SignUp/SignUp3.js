    ...
    <Background>
        ...
        <View style={styles.toptextbox}>
            ...
            <View style={styles.questionbox}>
              <View style={[{display: 'flex'}, {flexDirection: 'column'}, {alignItems: 'flex-start'}]}>
                <Text style={globalFonts.H3(globalColors.others.white.color)}>Enter your birthday!🎂</Text>
              </View>    
            </View>
            <View style={[{display: 'flex'}, {flexDirection: 'column'}, {alignItems: 'flex-start'}, {marginTop: 16}, {marginRight: 24}]}>
                  <Text style={globalFonts.BodyLarge.Bold(globalColors.others.white.color)}>Date of Birth</Text>
                  <TextInput 
                    style={styles.textinput}
                    placeholder = 'e.g. 12-27-1995'
      ...
      <View style={styles.bottomgreybutton}>
          <TouchableOpacity style={styles.continuebutton} onPress={() => {
            if (dob !== ''){ console.log(`Date of Birth: ${dob}`); navigation.navigate('SignUp4');}}}>

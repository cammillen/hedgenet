...
function CollectivePositionCard(params) {
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.imageTextFlexBox}>
                ...
                <Image source={params.stockLogo} style={styles.stockLogo} />
                {/* Title and Tags Vertical Box:  */}
                <View style={styles.textFlexBox}>
                    <Text style={[globalFonts.H6(globalColors.others.white.color), {marginBottom: 7}]}>{params.stock}</Text>
                    <Text style={[globalFonts.BodyMedium.Medium(globalColors.others.white.color), { lineHeight: 22 }]}>{params.sharesOwned} shares • {params.numMembers} members </Text>
                </View>
            </View>
...
export default CollectivePositionCard;
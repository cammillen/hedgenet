  ...
  return (
    <View style={styles.rect}>
      <View style={styles.header}>
        <Text style={globalFonts.H2(globalColors.others.white.color)}>${price}</Text>
        ...
        <Text style={globalFonts.BodyMedium.semiBold(globalColors.greyscale._300.color)}>  Last close</Text>
        </View>
      </View>
    </View>
  );

...
import { globalColours } from '../../styles/Colors.js'
        ...
        <View style={styles.group8}>
          ...
          <View style={styles.price_earning}>
            <View style={styles.image3Row}>
              <Image
                source={require("../../assets/icons/MarketStatsDetails/PriceEarning.png")}
                resizeMode="contain"
                style={styles.image3}
              ></Image>
              <Text style={styles.priceEarningsRatio}>Price-Earnings Ratio</Text>
          ...
          <View style={styles.divident_yield}>
            <View style={styles.image4Row}>
              <Image
                source={require("../../assets/icons/MarketStatsDetails/Dividend.png")}
                resizeMode="contain"
                style={styles.image4}
              ></Image>
          ...
          <View style={styles.average_volume}>
            <View style={styles.image5Row}>
              <Image
                source={require("../../assets/icons/MarketStatsDetails/AVGVolume.png")}
                resizeMode="contain"
                style={styles.image5}
              ></Image>
          ...
          <View style={styles.earning_per_share}>
            <View style={styles.image6Row}>
              <Image
                source={require("../../assets/icons/MarketStatsDetails/EPS.png")}
                resizeMode="contain"
                style={styles.image6}
              ></Image>
          ...
          <View style={styles.one_year_high}>
            <View style={styles.image7Row}>
              <Image
                source={require("../../assets/icons/MarketStatsDetails/1YearHigh.png")}
                resizeMode="contain"
                style={styles.image7}
              ></Image>
          ...
          <View style={styles.one_year_low}>
            <View style={styles.image8Row}>
              <Image
                source={require("../../assets/icons/MarketStatsDetails/1YearLow.png")}
                resizeMode="contain"
                style={styles.image8}
              ></Image>
